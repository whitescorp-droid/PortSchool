...
export default function AIPanel({ subject }: { subject: string }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', marginLeft: '-3rem', marginTop: '-3rem' }}>
      {/* Client-Side Sidebar */}
      <aside style={{ width: '280px', borderRight: '1px solid hsl(var(--border))', padding: '2rem', height: '100vh', position: 'sticky', top: 0 }}>
        ...
        <h2 style={{ marginBottom: '1rem', color: 'white' }}>{subject}</h2>
            ...
            <div key={t} style={{ marginBottom: '0.5rem' }}>
              <button 
                ...
                style={{ 
                  ...
                  background: topic === t ? 'hsl(var(--accent))' : 'transparent',
      ...
      <main style={{ flex: 1, padding: '3rem', overflowY: 'auto' }}>
        ...
        {error && (
          <div style={{ textAlign: 'center', marginTop: '5vh', padding: '2rem' }}>
        ...
        {loading && (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '60vh' }}>
            ...
            <p style={{ color: 'hsl(var(--muted-foreground))' }}>{topic} notları ve soruları oluşturuluyor.</p>
          </div>
        )}
            ...
            <div style={{ marginBottom: '4rem' }}>
              ...
              {!submitted ? (
                ...
                <div className="card" style={{ textAlign: 'center', border: '2px solid hsl(var(--primary))' }}>
                  ...
                  <button onClick={() => { setTopic(null); setData(null); }} className="btn" style={{ marginTop: '1rem', background: 'hsl(var(--secondary))' }}>
